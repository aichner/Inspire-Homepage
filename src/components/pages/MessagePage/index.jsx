      ...
      <MDBContainer id="message" className="py-5 my-5 text-center">
        {this.props.location.pathname === "/about" && (
          <div className="text-left mt-5">
            <h2>Impressum</h2>
            <p className="lead mb-0 font-weight-bold">InspireMedia GmbH</p>
            <p>
              <strong>Geschäftsführer: Christian Aichner</strong>
              <br />
              ...
              <p className="mt-2 mb-1">
                <strong>UID-Nummer:</strong> Ausstehend
              ...
              {!this.state.copy_uid ? (
                <MDBBtn
                  color="blue"
                  onClick={() =>
                    this.setState({ copy_uid: true }, () => copy("Ausstehend"))
                  }
                >
            ...
            <p className="mt-2 mb-1">
              <strong>Firmenbuchnummer:</strong> Ausstehend
            </p>
            <p className="mt-2 mb-1">
        ...
        {this.props.location.pathname === "/thankyou" && (
          <div className="py-5 mt-5">
            ...
            <Link to="/">
              <MDBBtn color="blue">Zurück zur Hompage</MDBBtn>
            </Link>
          </div>
        )}
        {this.props.location.pathname === "/privacy" && (
          <div className="text-left mt-5">
            ...
            <p>
              Kontakt:{" "}
              <a href="mailto:legal@inspiremedia.at">legal@inspiremedia.at</a>
            </p>
